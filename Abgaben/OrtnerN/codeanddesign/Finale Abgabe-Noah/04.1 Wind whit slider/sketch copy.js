...
function draw() {
  ...
  noStroke();
  fill(255);
  text('Partikel Frabe', 20, 40);
  text('Partikel Farbe', 20, 80);
  text('Hintergrundfarbe', 20, 120);
  text('Grösse', 20, 160);
  text('Anzahl Partikel', 20, 200);
  text('Geschwindigkeit', 20, 240);
...
let color2 = sliderB.value() /2;
  ...
  stroke(255, slider2.value(), slider.value());
  textSize(220);
  //noFill();
  fill(100);
  //text('lava', mouseX, mouseY);
  background(23, color1, color2, 50);
