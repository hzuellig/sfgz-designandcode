...
function draw() {
  ...
  bezier(Records[n].accuracy + 100, Records[n].verticalAccuracy * 10, Records[n].accuracy * 10, Records[n].verticalAccuracy * 10, Records[n].accuracy * 10, Records[n].verticalAccuracy * 10, Records[n].accuracy * 10, Records[n].verticalAccuracy * 10);
