...
function draw() {
  ...
  bezier(Records[n].accuracy + 20, Records[n].verticalAccuracy + 500, Records[n].accuracy * 10, Records[n].verticalAccuracy * 10, Records[n].accuracy * 10, Records[n].verticalAccuracy * 90, Records[n].accuracy + 100, Records[n].verticalAccuracy * 10);
